    ...
    public class Manager
    {
        ...
        public Manager()
        {
            ...
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<Models.ApplicationUser, Models.ApplicationUserBaseViewModel>();
                cfg.CreateMap<Controllers.RequestUser, Models.ApplicationUserDetailViewModel>();
                cfg.CreateMap<Models.ApplicationUserDetailViewModel, Models.ApplicationUserEditFormViewModel>();
                cfg.CreateMap<Models.ApplicationUserEditViewModel, Models.ApplicationUserDetailViewModel>();
        ...
        // Get All Users
        public IEnumerable<ApplicationUserBaseViewModel> UsersGetAll()
        {
            // Fetch all users        
            ...
            var userList = new List<ApplicationUserBaseViewModel>();
            foreach (var user in allUsers)
            {
                // Map the values all users to view model
                var appUser = mapper.Map<ApplicationUserBaseViewModel>(user);
        ...
        public IEnumerable<ApplicationUserBaseViewModel> FindUsers(string findString)
        {
            // Fetch all users
            var allUsers = UserManager.Users.ToList();
            ...
            return mapper.Map<IEnumerable<ApplicationUserBaseViewModel>>(userList);
        }


        // Get User by Id
        public ApplicationUserDetailViewModel GetUserById(string id)
        {
            ...
            // Map user details
            var details = mapper.Map<ApplicationUserDetailViewModel>(userAccount);
        ...
        public ApplicationUserDetailViewModel ApplicationUserEdit(ApplicationUserEditViewModel newItem)
        {
            ...
            if (result.Succeeded)
            {
                ...
                if (result.Succeeded)
                {
                    return mapper.Map<ApplicationUserDetailViewModel>(newItem);
                }
            }
            return null;
        }
