...
namespace ManageAccounts.Controllers
{
    ...
    public class AccountManagerController : Controller
    {
        ...
        public ActionResult Edit(string id)
        {
            ...
            {
                // Create a form
                var form = new ApplicationUserEditFormViewModel();
                form = m.mapper.Map<ApplicationUserEditFormViewModel>(o);
        ...
        [HttpPost]
        public ActionResult Edit(string id, ApplicationUserEditViewModel newItem)
        {
            // Validate the input
        ...
        [HttpPost]
        public ActionResult Delete(string id, ApplicationUserBaseViewModel user)
        {
