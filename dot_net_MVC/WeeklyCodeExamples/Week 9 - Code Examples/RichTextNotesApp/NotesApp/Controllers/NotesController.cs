...
namespace NotesApp.Controllers
{
    ...
    public class NotesController : Controller
    {
        ...
        // TODO 1 - Make sure that you study the views for each of these methods
        ...
        [HttpPost]
        //[ValidateInput(false)]
        public ActionResult Create(NoteAddViewModel newItem)
        {
            // Validate the input
        ...
        public ActionResult Edit(int? id)
        {
            ...
            else
            {
                ...
                var form = m.mapper.Map<NoteEditFormViewModel>(o);
        ...
        public ActionResult Edit(int? id, NoteEditViewModel newItem)
        {
            // Validate the input
            if (!ModelState.IsValid)
            {
