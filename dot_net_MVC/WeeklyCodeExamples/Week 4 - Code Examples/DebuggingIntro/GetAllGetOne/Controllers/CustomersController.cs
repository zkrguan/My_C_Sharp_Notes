...
namespace GetAllGetOne.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            // TODO 06 - Error - object reference not set to an instance of an object
            ...
            // Create a new CustomerEditContactInfoViewModel object
            // Intentionally leave out some property values
            var newCust = new CustomerEditContactInfoViewModel
            {
                //Fax = "(416) 661-4034",
        ...
        public ActionResult Edit(int? id)
        {
            ...
            else
            {
                ...
                // Notice that o is a CustomerBaseViewModel object
                // We must map it to a CustomerEditContactInfoForm object
                var editForm = m.mapper.Map<CustomerEditContactInfoFormViewModel>(o);
        ...
        [HttpPost]
        public ActionResult Edit(int? id, CustomerEditContactInfoViewModel newItem)
        {
            // Validate the input
            if (!ModelState.IsValid)
            {
            ...
            // TODO 16 - Error - cause a validation error when saving to the store
