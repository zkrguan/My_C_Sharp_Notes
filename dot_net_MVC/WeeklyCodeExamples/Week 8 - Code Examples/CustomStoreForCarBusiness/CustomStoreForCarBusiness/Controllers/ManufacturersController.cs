...
namespace CustomStoreForCarBusiness.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        // TODO 22 - Manufacturers controller, limited functionality (get all, get one, add vehicle)
        ...
        // TODO 23 - Used "attribute routing" for a custom URL segment (resource)
        ...
        public ActionResult AddVehicle(int? id)
        {
            ...
            else
            {
                ...
                var o = new VehicleAddFormViewModel();
        ...
        // TODO 24 - Used "attribute routing" for a custom URL segment (resource)
        // Allow a Manager to use this action/method
        [Authorize(Roles = "Manager")]
        [Route("manufacturers/{id}/addvehicle")]
        [HttpPost]
