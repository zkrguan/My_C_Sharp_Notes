...
{
    // TODO: 01 - View model classes for the ACCOUNT entity
    ...
    // TODO: 02 - AccountAdd view model class, with some nice rich data annotations
    ...
    public class AccountAddViewModel
    {
        ...
        // TODO: 03 - Coding style recommendation:
    ...
    public class AccountBaseViewModel : AccountAddViewModel
    {
    ...
    public class AccountAddPlainViewModel
    {
        public AccountAddPlainViewModel()
        {
            DateOfBirth = DateTime.Now.AddYears(-25);
        }
