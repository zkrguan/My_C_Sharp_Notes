...
{
    // TODO: 04 - View model classes for the VEHICLE (car, truck) entity
    ...
    // TODO: 05 - VehicleAdd view model class, with some nice rich data annotations
    ...
    {
        public VehicleBaseViewModel() { }

        public int Id { get; set; }
    }

    public class VehicleAddPlainViewModel
    {
        public VehicleAddPlainViewModel()
        {
            DateAvailable = DateTime.Now;
            ModelYear = DateAvailable.Year;
        }
