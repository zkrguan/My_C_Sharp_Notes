...
namespace AssocOneToMany.Controllers
{
    public class Manager
    {
        ...
        public IEnumerable<TeamBaseViewModel> TeamGetAll()
        {
            return mapper.Map<IEnumerable<Team>, IEnumerable<TeamBaseViewModel>>(ds.Teams.OrderBy(t => t.Name));
        }

        public TeamBaseViewModel TeamGetById(int id)
        {
            // Attempt to fetch the object
            var team = ds.Teams.Find(id);

            // Return the result, or null if not found
            return (team == null) ? null : mapper.Map<Team, TeamBaseViewModel> (team);
        }

        public TeamWithPlayersViewModel TeamGetByIdWithPlayers(int id)
        {
            // Attempt to fetch the object
            ...
            // Return the result, or null if not found
            return (teams == null) ? null : mapper.Map<Team, TeamWithPlayersViewModel>(teams);
        }

        // ############################################################
        // Player

        public IEnumerable<PlayerBaseViewModel> PlayerGetAll()
        {
            return mapper.Map<IEnumerable<Player>, IEnumerable<PlayerBaseViewModel>>(ds.Players.OrderBy(p => p.PlayerName));
        }
        ...
        public IEnumerable<PlayerWithTeamInfoViewModel> PlayerGetAllWithTeamInfo()
        {
            ...
            var players = ds.Players
                .Include("Team")
                .OrderBy(p => p.PlayerName);

            // The mapper returns the whole team object with the results
            return mapper.Map<IEnumerable<Player>, IEnumerable<PlayerWithTeamInfoViewModel>>(players);
        }

        public IEnumerable<PlayerWithTeamNameViewModel> PlayerGetAllWithTeamName()
        {
            ...
            return mapper.Map<IEnumerable<Player>, IEnumerable<PlayerWithTeamNameViewModel>>(players);
        }

        public PlayerBaseViewModel PlayerGetById(int id)
        {
            // Attempt to fetch the object
            var o = ds.Players.Find(id);

            // Return the result, or null if not found
            return (o == null) ? null : mapper.Map<Player, PlayerBaseViewModel>(o);
        }
