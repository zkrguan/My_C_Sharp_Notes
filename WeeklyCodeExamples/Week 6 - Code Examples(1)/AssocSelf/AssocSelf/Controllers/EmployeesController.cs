...
namespace AssocSelf.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        // TODO 41 - Attribute routing for nicer resource URLs; study this method pair
        ...
        public ActionResult EditSupervisor(int? id)
        {
            ...
            else
            {
                ...
                var form = m.mapper.Map<EmployeeEditSupervisorFormViewModel>(o);
                ...
                List<EmployeeBaseViewModel> employees = m.EmployeeGetAll().ToList();
                ...
                var selected = -1;
                if (o.ReportsToId.HasValue)
                {
                    selected = o.ReportsToId.GetValueOrDefault();
                    // Configure the "current supervisor" property, to display on the view
                    form.CurrentSupervisor = string.Format("{0}, {1}", o.ReportsTo.LastName, o.ReportsTo.FirstName);
                }
        ...
        [Route("employees/{id}/editsupervisor")]
        [HttpPost]
        public ActionResult EditSupervisor(int? id, EmployeeEditSupervisorViewModel newItem)
        {
            // Validate the input
        ...
        // TODO 46 - Attribute routing for nicer resource URLs; study this method pair
        ...
        public ActionResult EditDirectReports(int? id)
        {
            ...
            {
                // Create a form, based on the fetched matching object
                var form = m.mapper.Map<EmployeeEditDirectReportsFormViewModel>(o);
                ...
                var selectedValues = o.DirectReports.Select(e => e.EmployeeId);

                // Send the current direct reports, to display them on the form
                form.DirectReports = o.DirectReports.OrderBy(e => e.LastName).ThenBy(e => e.FirstName);
        ...
        [Route("employees/{id}/editdirectreports")]
        [HttpPost]
        public ActionResult EditDirectReports(int? id, EmployeeEditDirectReportsViewModel newItem)
        {
            // Validate the input
            if (!ModelState.IsValid)
            {
