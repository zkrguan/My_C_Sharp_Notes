...
namespace AssocManyToMany.Controllers
{
    public class MatchesController : Controller
    {
        ...
        // TODO 26 - Edit an employee's job duties
        ...
        public ActionResult EmployeeAndJobDuties(int? id)
        {
            ...
            else
            {
                ...
                var form = m.mapper.Map<EmployeeEditJobDutiesFormViewModel>(o);
        ...
        [HttpPost]
        public ActionResult EmployeeAndJobDuties(int? id, EmployeeEditJobDutiesViewModel newItem)
        {
            // Validate the input
        ...
        // TODO 27 - Edit a job duty's list of employees
        ...
        // Handle the data submitted by the browser user
        [HttpPost]
        public ActionResult JobDutyAndEmployees(int? id, JobDutyEditEmployeesViewModel newItem)
        {
            // Validate the input
            if (!ModelState.IsValid)
            {
