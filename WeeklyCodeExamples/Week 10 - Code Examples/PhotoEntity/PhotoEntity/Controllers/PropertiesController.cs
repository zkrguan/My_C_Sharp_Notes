...
namespace PhotoEntity.Controllers
{
    public class PropertiesController : Controller
    {
        ...
        {
            var form = new PropertyAddFormViewModel();
        ...
        [HttpPost]
        public ActionResult Create(PropertyAddViewModel newItem)
        {
            // Validate the input
        ...
        // TODO 10 - Controller method pair to add photo for an *existing* for-sale property
        ...
        public ActionResult AddPhoto(int? id)
        {
            ...
            {
                // Create a form
                var form = new PhotoAddFormViewModel();
        ...
        [HttpPost]
        [Route("properties/{id}/addphoto")]
        public ActionResult AddPhoto(int? id, PhotoAddViewModel newItem)
        {
            // Validate the input
        ...
        [HttpPost]
        public ActionResult Edit(int? id, PropertyBaseViewModel newItem)
        {
            // Validate the input
